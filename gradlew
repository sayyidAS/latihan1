...
<root>
  <item name="androidx.core.view.NestedScrollingChild boolean startNestedScroll(int) 0">
    <annotation name="androidx.annotation.IntDef">
      <val name="value" val="{androidx.core.view.ViewCompat.SCROLL_AXIS_NONE, androidx.core.view.ViewCompat.SCROLL_AXIS_HORIZONTAL, androidx.core.view.ViewCompat.SCROLL_AXIS_VERTICAL}" />
      <val name="flag" val="true" />
    </annotation>
  </item>
  <item name="androidx.core.view.NestedScrollingChild2 boolean dispatchNestedPreScroll(int, int, int[], int[], int) 4">
    <annotation name="androidx.annotation.IntDef">
      <val name="value" val="{androidx.core.view.ViewCompat.TYPE_TOUCH, androidx.core.view.ViewCompat.TYPE_NON_TOUCH}" />
    </annotation>
  </item>
  ...
  <item name="androidx.core.view.NestedScrollingChildHelper void stopNestedScroll(int) 0">
    <annotation name="androidx.annotation.IntDef">
      <val name="value" val="{androidx.core.view.ViewCompat.TYPE_TOUCH, andr